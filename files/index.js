...
const UUID = process.env.UUID || '1516e728-1e1d-4c1c-ab0a-a24c5f08c82b'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo01.lertjwqmur.cc.ua';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
